...
in addition I did stemming beacuse stemming makes the training data more dense. It reduces the size of the dictionary two or three-fold and the learning process will work better.
